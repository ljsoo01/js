...
const VIDEOS = [
  {
    id: "v0",
    name: "The Best of NAT KING COLE Greatest Hits",
    src: "https://tvvmvn.github.io/mytube/images/nat-cole-king.webp",
    category: "music",
  },
  {
    id: "v1",
    name: "YIRUMA - Best Playlist Ever",
    src: "https://tvvmvn.github.io/mytube/images/yiruma.webp",
    category: "music",
  },
  {
    id: "v2",
    name: "16 Best Places to Visit in Norway",
    src: "https://tvvmvn.github.io/mytube/images/norway.webp",
    category: "travel",
  },
  {
    id: "v3",
    name: "2023 Genesis G90 Review! $100,000 Rolls-Royce",
    src: "https://tvvmvn.github.io/mytube/images/genesis.webp",
    category: "car",
  },
];
...
export default function App() {
  ...
  const videoList = VIDEOS.filter(FILTER_MAP[filter]).map((video) => (
    <li key={video.id} className="mb-8">
      <img className="w-full" src={video.src} />
